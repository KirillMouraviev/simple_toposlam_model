...
public:
    ...
    bool checkTraversability(int x, int y, const T &map)
    {
        ...
        {
            /*std::cout << "Cell " << x + cells[k].first << ' ' << y + cells[k].second << std::endl;
            std::cout << "Cell on grid: " << map.CellOnGrid(x + cells[k].first, y + cells[k].second) << std::endl;
            if (map.CellOnGrid(x + cells[k].first, y + cells[k].second))
            {
                std::cout << "Cell is obstacle: " << map.CellIsObstacle(x + cells[k].first, y + cells[k].second) << std::endl;
            }*/
    ...
    bool checkLine(int x1, int y1, int x2, int y2, const T &map)
    {
        ...
        {
            //std::cout << "Traversability for " << x1 << ' ' << y1 << " is " << checkTraversability(x1, y1, map) << std::endl;
            //std::cout << "Traversability for " << x2 << ' ' << y2 << " is " << checkTraversability(x2, y2, map) << std::endl;
            ...
            for(int n = 1; n <= extraCheck; n++)
            {
                ...
                for(k = 1; k <= num; k++)
                    if(map.CellOnGrid(x1 - n*step_x, y1 + k*step_y))
                        ...
                        {
                            //std::cout << "Cell is obstacle " << x1 - n*step_x << ' ' << y1 + k*step_y << std::endl;
                            return false;
                        }
                for(k = 1; k <= num; k++)
                    if(map.CellOnGrid(x2 + n*step_x, y2 - k*step_y))
                        ...
                        {
                            //std::cout << "Cell is obstacle " << x2 + n*step_x << ' ' << y2 - k*step_y << std::endl;
                            return false;
                        }
            }
            error = 0;
